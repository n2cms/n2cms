...
namespace N2.Edit.Tests.Trash
{
    ...
    public class DeleteInterceptorTests : TrashTestBase
    {
        ...
        public void TrashedItem_MovedFromTrashcan_IsUnexpired()
        {
			...
			var th = new TrashHandler(persister, null, null, new ContainerRepository<TrashContainerItem>(persister, null, new Host(webContext, 1, 1), null), null, new ThreadContext());
			th.UseNavigationMode = true;
        ...
        public void Item_MovedIntoTrash_IsNeutralized()
        {
			...
			var th = new TrashHandler(persister, null, null, new ContainerRepository<TrashContainerItem>(persister, null, new Host(webContext, 1, 1), null), new StateChanger(), new ThreadContext());
			th.UseNavigationMode = true;
