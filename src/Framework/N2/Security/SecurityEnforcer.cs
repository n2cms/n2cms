...
namespace N2.Security
{
	...
	public class SecurityEnforcer : ISecurityEnforcer, IAutoStart
	{
		...
		public SecurityEnforcer(Persistence.IPersister persister, ISecurityManager security, ContentActivator activator, Web.IUrlParser urlParser, Web.IWebContext webContext, Configuration.HostSection config, IEventsManager eventsManager)
		{
		...
		{
			this.eventsManager.ItemSaving += ItemSavingEventHandler;
