...
{
  /// <summary> Rich text editor settings set (toolbars, features) </summary>
  public enum FreeTextAreaSettingsSet
  {
    /// <summary> Setting set is defined by configuration, DEFAULT by default </summary>
    UNDEFINED,
    /// <summary> Default N2 rich text editor toolbar, basic features, no additional toolbars </summary>
    DEFAULT,
  ...
  public class EditableFreeTextAreaAttribute : EditableTextBoxAttribute, IRelativityTransformer
  {
    ...
    public EditableFreeTextAreaAttribute(string title, int sortOrder, FreeTextAreaSettingsSet settingsSet)
      : base(title, sortOrder)
    {
    ...
    public FreeTextAreaSettingsSet SettingsSet { get; set; }
    ...
    public override void UpdateEditor(ContentItem item, Control editor)
    {
      ...
      string rt_mode = GetSettingsSetString(SettingsSet);
    ...
    protected virtual string GetSettingsSetString(FreeTextAreaSettingsSet settingsSet)
    {
      if (settingsSet == FreeTextAreaSettingsSet.UNDEFINED)
        settingsSet = FreeTextAreaSettingsSet.DEFAULT;

      if (settingsSet != FreeTextAreaSettingsSet.DEFAULT)
