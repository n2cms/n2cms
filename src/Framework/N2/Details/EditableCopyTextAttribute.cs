...
namespace N2.Details
{
    ...
    public class EditableCopyTextAttribute : AbstractEditableAttribute, IDisplayable, IWritingDisplayable
    {
        ...
        public EditableCopyTextAttribute()
            : this(null, 50)
        {
        }
        ...
        public EditableCopyTextAttribute(string title, int sortOrder)
        ...
        protected override Control AddEditor(Control container)
        {
            ...
            btn.ID = Name + "_copy";
            btn.Text = "Copy Text";
            btn.Attributes["style"] = "display:block;margin-top:5px;";
...
$(document).ready(function() {{
    ...
    $('#{btn.ClientID}').click(function(e) {{
        ...
        {{
            ...
            ScriptManager.RegisterStartupScript(page, typeof(Page), "CopyTextScript", scriptStr.ToString(), false);
        ...
        protected virtual void ModifyEditor(TextBox tb)
        {
            ...
            if (readOnly == true) { tb.ReadOnly = true; tb.CssClass = "copyTextEditorReadOnly"; }  
