...
namespace N2.Tests.Persistence.NH
{
	...
	public class PersisterIntegrityTests : PersisterTestsBase
	{
		...
		public override void SetUp()
		{
			...
			IntegrityEnforcer enforcer = new IntegrityEnforcer(persister, integrity, events);
			enforcer.Start();

			new BehaviorInvoker(persister, new N2.Definitions.Static.DefinitionMap(), events).Start();
		}
