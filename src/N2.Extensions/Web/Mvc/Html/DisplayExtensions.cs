...
namespace N2.Web.Mvc.Html
{
	public static class DisplayExtensions
	{
		...
		public static Displayable Display<TItem>(this IItemContainer<TItem> container, string detailName, TItem item)
			where TItem : ContentItem
		{
			...
			where TItem : ContentItem
		{
			...
			return container.Display(member.Member.Name, item);
		}
	}
