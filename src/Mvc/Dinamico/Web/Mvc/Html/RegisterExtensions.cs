...
namespace N2.Web.Mvc.Html
{
	public static class RegisterExtensions
	{
		...
		public static DefinitionRegistrationExpression GetRegistrationExpression<T>(ContentHelper<T> content) where T : class
		{
			return content.Html.ViewData["RegistrationExpression"] as DefinitionRegistrationExpression;
		}
