...
setInterval(function() {{ $.get('{0}?activity=View&{1}={2}'); }}, {3});
</script>", Url.ResolveTokens("{ManagementUrl}/Content/Activity/Notify.ashx"), PathData.SelectedQueryKey, context.Selected.Path, collaboration.PingInterval * 1000));
