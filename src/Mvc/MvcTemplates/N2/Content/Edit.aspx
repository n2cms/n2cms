...
<asp:Content ID="ct" ContentPlaceHolderID="Toolbar" runat="server">
    ...
    <n2:OptionsMenu id="om" runat="server">
        ...
        <asp:HyperLink ID="hlFuturePublish" NavigateUrl="#futurePanel" CssClass="command plain iconed future hidden-action" runat="server" meta:resourceKey="hlSavePublishInFuture">Save and publish version in future</asp:HyperLink>
		<asp:LinkButton ID="btnUnpublish" OnCommand="OnUnpublishCommand" runat="server" CssClass="command plain iconed unpublish hidden-action" meta:resourceKey="btnUnpublish">Unpublish</asp:LinkButton>
    </n2:OptionsMenu>
