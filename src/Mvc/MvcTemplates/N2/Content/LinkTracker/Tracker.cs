...
namespace N2.Edit.LinkTracker
{
	...
	public class Tracker : IAutoStart
	{
		...
		private readonly N2.Web.IUrlParser urlParser;
		private readonly N2.Web.IErrorNotifier errorHandler;
		private readonly Logger<Tracker> logger;

		public Tracker(Persistence.IPersister persister, N2.Web.IUrlParser urlParser, ConnectionMonitor connections, N2.Web.IErrorNotifier errorHandler, Configuration.EditSection config, IEventsManager eventsManager)
		{
			...
			if (config.LinkTracker.Enabled)
			{
				...
				{
					eventsManager.ItemSaving += persister_ItemSaving;
				};
