...
namespace N2.Management.Files
{
	...
	public class VirtualFolderInitializer : IAutoStart
	{
		...
		public VirtualFolderInitializer(IHost host, IPersister persister, VirtualNodeFactory virtualNodes, DatabaseStatusCache dbStatus, EditSection editConfig, FolderNodeProvider nodeProvider)
		{
			this.host = host;
