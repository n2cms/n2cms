...
<asp:Content ID="cc" ContentPlaceHolderID="Content" runat="server">
    ...
    <h1><%= GetLocalResourceString("SelectFiles", "Select files to upload") %></h1>

    <div class="tabPanel">
        
        <div id="fileupload">
            <p><input id="fuAlternative" runat="server" type="file" name="files[]" multiple="multiple" /></p>
            <p><asp:Button runat="server" ID="btnAlternative" OnCommand="btnAlternative_Command" Text="Upload" CssClass="upload" meta:resuorceKey="btnAlternative" /></p>
            <p class="droparea"><em><%= GetLocalResourceString("DropFiles", "Or drop files here") %></em></p>
    ...
    <style>
        .droparea { margin:10px 0; padding:20px 10px; border:dashed 1px silver; border-radius:4px; }
        .droparea:hover { border-style:solid; box-shadow: inset 0 0 25px #ddd; }
    </style>
