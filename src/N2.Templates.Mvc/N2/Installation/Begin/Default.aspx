...
<body>
    ...
    <div>
		...
		<div class="tabPanel">
			...
			<p>Next you need to log in. Unless you already have changed this during installation the username/password is <strong>admin/changeme</strong> (this can be modified in web.config).</p>
