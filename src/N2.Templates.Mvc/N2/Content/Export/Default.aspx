	    ...
	    <asp:MultiView ID="uploadFlow" runat="server" ActiveViewIndex="0">
		    ...
		    <asp:View ID="preView" runat="server">
			    ...
			    <asp:Repeater ID="rptAttachments" runat="server">
			        <ItemTemplate>
			            <div class="file"><asp:Image runat="server" ImageUrl="~/N2/Resources/Img/ico/png/page_white.png" alt="file" /><%# Eval("Url") %> <span class="warning"><%# CheckExists((string)Eval("Url")) %></span></div>
			        </ItemTemplate>
			    </asp:Repeater>
		    </asp:View>
	    </asp:MultiView>
