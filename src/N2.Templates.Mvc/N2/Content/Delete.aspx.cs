...
namespace N2.Edit
{
	[NavigationLinkPlugin("Delete", "delete", "Content/delete.aspx?selected={selected}&alert=true", Targets.Preview, "|Management|/Resources/icons/cross.png", 30, GlobalResourceClassName = "Navigation")]
    [ToolbarPlugin("DEL", "delete", "Content/delete.aspx?selected={selected}", ToolbarArea.Operations, Targets.Preview, "|Management|/Resources/icons/cross.png", 60, ToolTip = "delete", GlobalResourceClassName = "Toolbar")]
    [ControlPanelLink("cpDelete", "|Management|/Resources/icons/cross.png", "Content/Delete.aspx?selected={Selected.Path}", "Delete this page", 60, ControlPanelState.Visible)]
