...
{
    [ToolbarPlugin("", "versions", "Content/Versions/Default.aspx?selected={selected}", ToolbarArea.Preview, Targets.Preview, "~/N2/Resources/Img/ico/png/book_previous.png", 90, 
        ToolTip = "versions", 
