...
namespace N2.Edit
{
    [NavigationLinkPlugin("Copy", "copy", "javascript:n2nav.memorize('{selected}','copy');", "", "~/N2/Resources/Img/ico/png/page_copy.png", 50, GlobalResourceClassName = "Navigation")]
	[ToolbarPlugin("COPY", "copy", "javascript:n2.memorize('{selected}','copy');", ToolbarArea.Operations, "", "~/N2/Resources/Img/ico/png/page_copy.png", 40, ToolTip = "copy", GlobalResourceClassName = "Toolbar")]
