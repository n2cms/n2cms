...
{
    [ToolbarPlugin("PERM", "security", "~/N2/Content/Security/Default.aspx?selected={selected}", ToolbarArea.Preview, Targets.Preview, "~/N2/Resources/Img/Ico/png/key.png", 100, 
