...
{
    [ToolbarPlugin("PERM", "security", "Content/Security/Default.aspx?selected={selected}", ToolbarArea.Preview, Targets.Preview, "|Management|/Resources/icons/key.png", 100, 
