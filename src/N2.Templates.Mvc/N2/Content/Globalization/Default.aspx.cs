...
{
    [ToolbarPlugin("LANGS", "globalization", "~/N2/Content/Globalization/Default.aspx?selected={selected}", ToolbarArea.Preview, Targets.Preview, "~/N2/Resources/Img/Ico/png/world.png", 150, ToolTip = "view translations", GlobalResourceClassName = "Toolbar")]
