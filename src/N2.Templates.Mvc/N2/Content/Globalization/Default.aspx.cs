...
{
    [ToolbarPlugin("LANGS", "globalization", "Content/Globalization/Default.aspx?selected={selected}", ToolbarArea.Preview, Targets.Preview, "~/N2/Resources/Img/Ico/png/world.png", 150, ToolTip = "view translations", GlobalResourceClassName = "Toolbar")]
