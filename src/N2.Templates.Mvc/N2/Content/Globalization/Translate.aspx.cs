        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (language != null)
            {
                ...
                if (translation != null)
                {
                    ...
                    string url = Engine.EditUrlManager.GetEditExistingItemUrl(translation);
                ...
                else if (Selection.SelectedItem.Parent != null)
                {
					...
					if(parentTranslation != null)
					{
						...
						Url url = Engine.EditUrlManager.GetEditNewPageUrl(parentTranslation, definition, null, CreationPosition.Below);
