...
{
	[ToolbarPlugin("SETTINGS", "settings", "Content/Settings/Default.aspx?selected={selected}", ToolbarArea.Options, "navigation", "|Management|/Resources/icons/wrench.png", -10, ToolTip = "settings", GlobalResourceClassName = "Toolbar")]
