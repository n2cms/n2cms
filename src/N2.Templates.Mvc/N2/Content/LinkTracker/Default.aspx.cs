...
{
    [ToolbarPlugin("LINKS", "linktracker", "~/N2/Content/LinkTracker/Default.aspx?selected={selected}", ToolbarArea.Preview, Targets.Preview, "~/N2/Resources/Img/ico/png/link_break.png", 160, 
