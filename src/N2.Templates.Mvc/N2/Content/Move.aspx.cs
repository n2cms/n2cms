...
namespace N2.Edit
{
    ...
    [NavigationLinkPlugin("Cut", "move", "javascript:n2nav.memorize('{selected}','move');", "", "|Management|/Resources/icons/cut.png", 42, GlobalResourceClassName = "Navigation")]
    [ToolbarPlugin("CUT", "move", "javascript:n2.memorize('{selected}','move');", ToolbarArea.Operations, "", "|Management|/Resources/icons/cut.png", 30, ToolTip = "move", GlobalResourceClassName = "Toolbar")]
