...
namespace N2.Edit
{
    ...
    [NavigationLinkPlugin("Cut", "move", "javascript:n2nav.memorize('{selected}','move');", "", "~/N2/Resources/Img/ico/png/cut.png", 42, GlobalResourceClassName = "Navigation")]
    [ToolbarPlugin("CUT", "move", "javascript:n2.memorize('{selected}','move');", ToolbarArea.Operations, "", "~/N2/Resources/Img/Ico/png/cut.png", 30, ToolTip = "move", GlobalResourceClassName = "Toolbar")]
