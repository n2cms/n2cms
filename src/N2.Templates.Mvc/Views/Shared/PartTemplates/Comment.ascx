...
<div style="position:relative;top:20px;">
	<% N2.Web.UI.PartUtilities.WriteTitleBar(Html.ViewContext.Writer, N2.Context.Current.EditUrlManager, N2.Context.Current.Resolve<N2.Engine.IContentAdapterProvider>(), N2.Context.Current.Definitions.GetDefinition(Model.GetType()), Model); %>
</div>
<% } %>
