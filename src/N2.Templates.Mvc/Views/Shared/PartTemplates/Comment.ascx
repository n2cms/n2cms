...
<div style="position:relative;top:20px;">
	<% N2.Web.UI.PartUtilities.WriteTitleBar(Html.ViewContext.Writer, N2.Context.Current.EditManager, N2.Context.Current.Definitions.GetDefinition(Model.GetType()), Model); %>
</div>
<% } %>
