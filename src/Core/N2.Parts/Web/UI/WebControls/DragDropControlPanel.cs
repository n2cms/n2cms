...
[assembly: WebResource("N2.Parts.Web.UI.WebControls.layout_edit.png", "image/png")]
[assembly: WebResource("N2.Parts.Web.UI.WebControls.page_refresh.png", "image/png")]
...
namespace N2.Parts.Web.UI.WebControls
{
	public class DragDropControlPanel : ControlPanel
	{
		...
		protected virtual void AddDragButton()
		{
			...
			DragModeLink.Text = FormatImageAndText(Page.ClientScript.GetWebResourceUrl(typeof(DragDropControlPanel), "N2.Parts.Web.UI.WebControls.layout_edit.png"), OrganizeText); ;
		...
		private void RegisterStyles()
		{
			if(string.IsNullOrEmpty(DragDropStyleSheetUrl))
				Register.StyleSheet(Page, typeof (DragDropControlPanel), "N2.Parts.Web.UI.WebControls.Parts.css");
			else 
