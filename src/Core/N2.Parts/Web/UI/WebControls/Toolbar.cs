...
[assembly: WebResource("N2.Parts.Web.UI.WebControls.delete.png", "image/png")]
[assembly: WebResource("N2.Parts.Web.UI.WebControls.page_edit.png", "image/png")]
...
namespace N2.Parts.Web.UI.WebControls
{
	public class Toolbar : Control
	{
		...
		public Toolbar(ContentItem item, ItemDefinition definition, string gripperImageUrl)
		{
		...
		{
			return Page.ClientScript.GetWebResourceUrl(typeof (Toolbar), "N2.Parts.Web.UI.WebControls.page_edit.png");
		}

		private string GetDeleteIcon()
		{
			return Page.ClientScript.GetWebResourceUrl(typeof (Toolbar), "N2.Parts.Web.UI.WebControls.delete.png");
		}
	}
}
