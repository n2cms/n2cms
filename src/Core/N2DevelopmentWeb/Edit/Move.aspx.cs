...
namespace N2.Edit
{
	[NavigationPlugIn("Cut", "move", "javascript:n2nav.memorize('{selected}','move');", "", "~/edit/img/ico/cut.gif", 40)]
	[ToolbarPlugIn("", "move", "javascript:n2.memorize('{selected}','move');", ToolbarArea.Navigation, "",
		"~/Edit/Img/Ico/cut.gif", 30,
		ToolTip = "move",
