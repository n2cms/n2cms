...
{
	[ToolbarPlugin("", "linktracker", "~/Edit/LinkTracker/Default.aspx?selected={selected}", ToolbarArea.Preview, "preview", "~/Edit/LinkTracker/Img/link_break.gif", 160, ToolTip = "tracks inbound/outbound links", GlobalResourceClassName = "Toolbar")]
