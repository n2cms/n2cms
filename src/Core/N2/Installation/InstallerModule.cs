	...
	public class InstallerModule : IHttpModule
	{
		...
		public void Init(HttpApplication context)
		{
			if (!alreadyChecked)
			{
				...
				{
					string message = "There seems to be a problem the configuration and/or database. Please check the web configuration and navigate to the installer located at /edit/install. Available information: " 
