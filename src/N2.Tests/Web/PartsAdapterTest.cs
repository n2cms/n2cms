...
namespace N2.Tests.Web
{
	...
	public class PartsAdapterTest : ItemPersistenceMockingBase
	{
		...
		public override void SetUp()
		{
            ...
            engine.AddComponentInstance(null, typeof(IDefinitionManager), new DefinitionManager(new DefinitionBuilder(finder, new EngineSection()), new N2.Engine.Workflow.StateChanger(), null));
