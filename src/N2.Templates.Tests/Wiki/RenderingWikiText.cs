    ...
    public class RenderingWikiText : ItemTestsBase
    {
        ...
        public void Renders_ImageTagWithAnchor_WhenImageExists()
        {
            ...
            try
            {
				...
				Assert.That(html, Is.EqualTo("<a href=\"/Upload/Wiki/n2.png\"><img src=\"/Upload/Wiki/n2.png\" alt=\"n2.png\" style=\"width:500px;\" /></a>"));
            }
            finally
            {
        ...
        public void Renders_ImageTag_WithAnchor_AndAltParameter()
        {
            ...
            try
            {
				...
				Assert.That(html, Is.EqualTo("<a href=\"/Upload/Wiki/n2.png\"><img src=\"/Upload/Wiki/n2.png\" alt=\"N2 CMS Logo\" style=\"width:500px;\" /></a>"));
            }
            finally
            {
                InternalLinkRenderer.FileExists = temp;
