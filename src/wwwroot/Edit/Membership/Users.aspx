...
<asp:Content ID="Content4" ContentPlaceHolderID="Content" runat="server">
	<asp:DataGrid ID="dgrUsers" runat="server" DataSourceID="odsUsers" 
		...
		<Columns>
			...
			<asp:TemplateColumn>
				<ItemTemplate>
					<asp:LinkButton runat="server" CommandName="Delete" meta:resourcekey="ButtonColumnResource1" OnClientClick="return confirm('Would you really like to delete this user?');" />
				</ItemTemplate>
			</asp:TemplateColumn>
		</Columns>
	</asp:DataGrid>
